...
/* Gazette — the current-affairs pipeline. Its tables live here with the rest,
   not under src/lib: this file is what drizzle-kit reads and what the client is
   registered with, so a table defined anywhere else is invisible to both. */
