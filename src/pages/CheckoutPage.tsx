...
import { ANNUAL_TOTAL, MONTHLY_PRICE, type BillingCycle } from "../data/plans";
...
// Checkout renders outside both the app and marketing shells — a bare page
// keeps the payment step distraction-free for logged-in and public visitors
    ...
    <div className="checkout-shell">
      <header className="checkout-shell__bar">
        <Link to="/" className="checkout-shell__brand">
          <span className="checkout-shell__logo" aria-hidden>
            <span />
            <span />
          </span>
          onelystopp
      ...
      <CheckoutShell>
        <div className="checkout-success">
          ...
          <div className="checkout-success__actions">
            <Button onClick={() => navigate("/home")}>Start revising</Button>
