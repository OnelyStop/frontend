...
export function LegalDoc({
  ...
  return (
    <main className="px-5 pt-[clamp(136px,14vw,176px)] sm:px-8 lg:px-16">
      ...
      <div className="mx-auto grid max-w-300 gap-8 pt-[clamp(40px,5vw,72px)] pb-[clamp(64px,8vw,120px)] lg:grid-cols-[220px_minmax(0,1fr)] lg:gap-[clamp(32px,6vw,96px)]">
        <nav className="grid content-start gap-1 self-start text-[14px] [counter-reset:toc] lg:sticky lg:top-30">
