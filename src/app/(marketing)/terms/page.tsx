...
export default function Page() {
  return (
    <LegalDoc
      eyebrow="Legal"
      title="Terms of service"
      intro="The agreement between you and onelystop. The parts that matter are what the marking actually is, and what happens to your money if you stop."
      meta={[
    ...
    >
      ...
      <section id="who">
        ...
        <p>
          ...
          guardian agrees to these terms on your behalf. If you are paying for a
          plan you must be 18 or over, or have permission from the person whose
          payment method is used.
        </p>
        <LegalTodo>
          <strong>Before launch:</strong> set the minimum age, and decide how
          parental agreement is captured at sign-up.
        </LegalTodo>
      </section>
      ...
      <section id="marking">
        ...
        <ul>
          <li>
            <strong>The marking is a model reading a mark scheme.</strong> It is
            fast and it is specific, and it is not a teacher, an examiner, or
            your exam board.
          </li>
          <li>
      ...
      <section id="use">
        ...
        <ul>
          <li>
            scrape, bulk-download or resell our question bank, mark schemes or
            marking output;
          </li>
          <li>
            submit another person&rsquo;s work as your own where that breaches
            your school&rsquo;s or exam board&rsquo;s rules;
          </li>
          <li>
            use onelystop for any coursework or assessment where your exam board
            prohibits AI assistance. That is your responsibility to check;
          </li>
          <li>
      ...
      <section id="content">
        ...
        <p>
          You keep ownership of everything you write and upload. You grant us a
          limited licence to store and process it solely to provide the service
          to you: marking it, tracking your progress, scheduling your revision.
          That licence ends when you delete the content or your account.
        </p>
        <p>
          We do not use your work to train AI models, and we do not publish it.
        </p>

        <h3>Exam board material</h3>
        <p>
          onelystop is not affiliated with, endorsed by, or connected to OCR,
          AQA, Pearson Edexcel, WJEC or Cambridge International. Specification
          codes and paper references are used only to identify which syllabus a
          question belongs to. Past papers and mark schemes remain the copyright
          of their respective awarding bodies, and we host only what we are
          permitted to host.
        </p>

        <h3>Our material</h3>
        <p>
          The software, design and original content of onelystop belong to us.
          Using the service does not transfer any of it to you.
        </p>
      </section>
      ...
      <section id="billing">
        ...
        <ul>
          ...
          <li>
            <strong>Paid plans renew automatically</strong> at the interval you
            chose, until you cancel.
          </li>
          <li>
            <strong>You can cancel at any time.</strong> Cancelling stops the
            next renewal; you keep paid access until the end of the period you
            have already paid for.
          </li>
          <li>
            <strong>Statutory rights.</strong> As a UK consumer buying online
            you normally have 14 days to change your mind. Where you ask us to
            start immediately and use the service in that window, we may reduce
            a refund to reflect what you used.
          </li>
          <li>
        ...
        <LegalTodo>
          <strong>Before launch:</strong> confirm prices, billing intervals and
          the refund position against what the pricing page says.
        </LegalTodo>
      </section>
      ...
      <section id="availability">
        ...
        <p>
          ...
          service. We may change features, and we may retire ones that are not
          working. Where a change materially reduces what you are paying for we
          will tell you, and you may cancel for a pro-rata refund.
        </p>
      </section>
      ...
      <section id="liability">
        ...
        <p>
          ...
          by our negligence, for fraud, or for anything else that cannot be
          limited by law. Your statutory rights as a consumer are unaffected.
        </p>
        <p>
          Subject to that, we are not liable for indirect or consequential loss,
          and specifically not for examination results, grades or academic
          outcomes. onelystop is practice material; it is not a guarantee of
          performance.
        </p>
        <LegalTodo>
      ...
      <section id="law">
        ...
        <p>
          ...
          courts of England and Wales have jurisdiction. If you live in Scotland
          or Northern Ireland you may bring proceedings in your own courts.
        </p>
      </section>
    </LegalDoc>
  );
