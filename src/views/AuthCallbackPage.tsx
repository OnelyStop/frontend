...
// The URL fragment is never sent to the server, so this is inherently
// client-only: reading it during render would make SSR and the first client
// render disagree. Resolved in an effect instead.
